...
class ExporterXacro(Exporter):
    ...
    def build(self, robot: Robot):
        ...
        self.append(f'<robot xmlns:xacro="http://www.ros.org/wiki/xacro">')
        self.append(f'<xacro:macro name="{robot.name}">')
